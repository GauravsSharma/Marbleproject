...
const ProductCard = ({
  ...
  return (
    <>
      <div
        className={`w-full sm:w-${width} h-auto p-4 mt-2 rounded-lg border border-gray-200 bg-white hover:shadow-2xl transition-all duration-500`}
      >
        {/* Image Section */}
        ...
        {/* Title Section */}
        <div className="text-gray-800 font-medium mt-2 text-sm sm:text-base">
